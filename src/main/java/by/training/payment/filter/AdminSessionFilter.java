...
/**
 * The filter is designed to prevent access to pages in the jsp/admin directory
 * to users who are not administrators or blocked users. When you try to access
 * these pages, you are redirected to the login page
