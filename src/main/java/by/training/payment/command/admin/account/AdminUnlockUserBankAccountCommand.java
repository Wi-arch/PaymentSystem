...
public class AdminUnlockUserBankAccountCommand extends AbstractBankAccountCommand {

	private static final Logger LOGGER = Logger.getLogger(AdminUnlockUserBankAccountCommand.class);
