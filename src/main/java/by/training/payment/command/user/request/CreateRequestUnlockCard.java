...
public class CreateRequestUnlockCard extends AbstractCreateRequestCommand {

	private static final Logger LOGGER = Logger.getLogger(CreateRequestUnlockCard.class);
