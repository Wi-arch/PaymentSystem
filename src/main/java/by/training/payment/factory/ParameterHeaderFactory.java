...
public class ParameterHeaderFactory {
	...
	public static final String CARD_EXPIRY_PARAMETER_HEADER = "Card expiry date";
	...
	private ParameterHeaderFactory() {
		prototypes.put(CARD_EXPIRY_PARAMETER_HEADER, new ParameterHeader(CARD_EXPIRY_PARAMETER_HEADER));
